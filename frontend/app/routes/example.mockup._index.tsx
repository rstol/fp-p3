...
export default function Mockup() {
  ...
  const [featureImportance, setFeatureImportance] = useState('Player Positions');
  ...
  return (
    <div className="mx-auto max-w-7xl py-6">
      <CardHeader className="pb-2">
        <CardTitle className="pb-2 text-center text-xl">Basketball Play Tactics Tool</CardTitle>
      </CardHeader>
          ...
          <Card className="rounded-none bg-gray-100">
            ...
            <CardContent className="space-y-4 p-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={featureImportance} onValueChange={setFeatureImportance}>
                  <SelectTrigger className="bg-white">
                    <SelectValue placeholder="Select feature" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="Player Positions">Player Positions</SelectItem>
